...
public class AdocaoController {
    ...
    public ResponseEntity<String> solicitar(@RequestBody @Valid Adocao adocao) {
        try {
            ...
            return ResponseEntity.badRequest().body("Erro ao realizar a solicitação. Detalhe: " + e.getMessage());
        }
    }
    ...
    public ResponseEntity<String> aprovar(@RequestBody @Valid Adocao adocao) {
        try {
            ...
            return ResponseEntity.badRequest().body("Erro ao realizar a aprovação. Detalhe: " + e.getMessage());
        }
    }
    ...
    public ResponseEntity<String> reprovar(@RequestBody @Valid Adocao adocao) {
        try {
            ...
            return ResponseEntity.badRequest().body("Erro ao realizar a reprovação. Detalhe: " + e.getMessage());
        }
    }
